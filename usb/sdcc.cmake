...
FIND_FILE(SDCC_COMPILER_EXE_FILE "sdcc.exe" PATHS ENV INCLUDE)
FIND_FILE(SDCC_COMPILER_FILE "sdcc" PATHS ENV INCLUDE)

if (EXISTS ${SDCC_COMPILER_FILE})
set( SDCC_COMPILER ${SDCC_COMPILER_FILE})
elseif (EXISTS ${SDCC_COMPILER_EXE_FILE})
set( SDCC_COMPILER ${SDCC_COMPILER_EXE_FILE})
else()
message(FATAL_ERROR "SDCC is not found. ")
endif()

set(CMAKE_SYSTEM_NAME Generic)
set(CMAKE_C_COMPILER ${SDCC_COMPILER})
set(CMAKE_ASM_COMPILER ${SDCC_COMPILER})
...
set(CMAKE_FIND_ROOT_PATH ${SDCC_LOCATION})
