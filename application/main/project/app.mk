...
ifeq (yes,$(strip $(DCDC)))
	...
	CFLAGS += -DNRFX_POWER_CONFIG_DEFAULT_DCDCEN=1
	ASMFLAGS += -DPOWER_ENABLED=1
	ASMFLAGS += -DNRFX_POWER_ENABLED=1
	ASMFLAGS += -DNRFX_POWER_CONFIG_DEFAULT_DCDCEN=1
endif
...
CFLAGS += -DNRF_LOG_BACKEND_UART_TX_PIN=19
...
ASMFLAGS += -DNRF_LOG_BACKEND_UART_TX_PIN=19
