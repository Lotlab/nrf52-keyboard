...
#define PRODUCT "GUQIN68" /* 硬件名称，用于USB和蓝牙显示 */
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 7, 6, 5, 4, 3 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 21, 22, 23, 24, 25, 28, 29, 30, 26, 27, 11, 12, 13, 14, 15, 16 };
