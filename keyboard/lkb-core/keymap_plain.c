...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	KEYMAP(
		...
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_NO, KC_LSFT, KC_NO, 
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_FN0, KC_LALT, KC_MENU, KC_LCTL, KC_NO, KC_NO, KC_NO),
