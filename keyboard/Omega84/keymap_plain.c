...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_FN0, 
		KC_HOME, KC_BSPC, KC_EQL, KC_MINS, KC_0, KC_INS, KC_PSCR, KC_F12, KC_F11, KC_F10, 
		KC_DEL, KC_PGDN, KC_ENT, KC_QUOT, KC_SCLN, KC_PGUP, KC_BSLS, KC_RBRC, KC_LBRC, KC_P, 
		KC_RGHT, KC_DOWN, KC_LEFT, KC_RCTL, KC_END, KC_UP, KC_RSFT, KC_SLSH),

	KEYMAP(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		KC_TRNS, KC_MYCM, KC_MAIL, KC_CALC, KC_MSEL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		KC_TRNS, KC_BTN1, KC_MS_U, KC_BTN2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
