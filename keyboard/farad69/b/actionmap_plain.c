...
const action_t actionmaps[][MATRIX_ROWS][MATRIX_COLS] = { 
	[0] = ACTIONMAP(
		ESC, 1, 2, 3, 4, 5, 6, 7, 8, 9, 0, MINS, EQL, NLCK, 
		TAB, Q, W, E, R, T, Y, U, I, O, P, BSLS, P7, P8, 
		FN0, A, S, D, F, G, H, J, K, L, ENT, P4, P5, P6, 
		LSFT, Z, X, C, V, B, N, M, COMM, FN1, UP, P1, P2, P3, 
		LCTL, LGUI, LALT, FN2, SPC, FN3, LEFT, DOWN, RGHT, P0, PDOT, P9, BSPC),

	[1] = ACTIONMAP(
		GRV, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12, PSCR, 
		FN4, BTN1, MS_U, BTN2, TRNS, TRNS, TRNS, TRNS, TRNS, LBRC, RBRC, TRNS, TRNS, INS, 
		...
		TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, PGUP, PGDN, DEL, TRNS),
	[2] = ACTIONMAP(
