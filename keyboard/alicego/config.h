...
#define MANUFACTURER "ALICE" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "alice" /* 硬件名称，用于USB和蓝牙显示 */
...
// 旋钮正向按钮映射
#define ROTARY_ENCODER_POS 4,6
// 旋钮负向按钮映射
#define ROTARY_ENCODER_NEG 9,6
...
static const uint8_t column_pin_array[MATRIX_COLS] = { 16, 17, 18, 22, 23, 24, 25 };
